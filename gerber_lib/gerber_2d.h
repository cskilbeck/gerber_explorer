...
namespace gerber_lib
{
    ...
    struct vec2d
    {
        ...
        vec2d(vec2d const &o, matrix const &transform) : vec2d(o.x, o.y, transform)
        {
        }
...
GERBER_MAKE_FORMATTER(gerber_lib::vec2d);
GERBER_MAKE_FORMATTER(gerber_lib::rect);
GERBER_MAKE_FORMATTER(gerber_lib::matrix);
