...
namespace gerber_3d
{
    ...
    void log_drawer::set_gerber(gerber *g)
    {
        gerber_file = g;
    ...
    void log_drawer::fill_elements(gerber_draw_element const *elements, size_t num_elements, gerber_polarity polarity, int entity_id)
    {
