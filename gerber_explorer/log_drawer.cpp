...
namespace gl
{
    ...
    gerber_lib::gerber_error_code log_drawer::fill_elements(gerber_lib::gerber_draw_element const *elements, size_t num_elements,
                                                            gerber_lib::gerber_polarity polarity, gerber_lib::gerber_net *gnet)
    {
